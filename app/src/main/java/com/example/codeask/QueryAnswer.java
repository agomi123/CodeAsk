...
public class QueryAnswer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = findViewById(R.id.recyclejr5);
...
// finally change the color
        ...
        Intent it=getIntent();
        postid=it.getStringExtra("queryid");
        ...
        commentbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(commentedt.getText().toString().equals("")){
                    Toast.makeText(QueryAnswer.this,"You cannot send empty comment",Toast.LENGTH_SHORT).show();
                }
                else{
                    addComment();
                }
    ...
    private void readComment(){
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference("Answers").child(postid);
